...
def generate_latex():
    ...
    items = [
        ...
        LayoutItem(kepler.semi_minor_axis),
        ...
        LayoutItem(kepler.orbital_energy),
        LayoutItem(kepler.c3),
        LayoutItem(kepler.circular_velocity),
        LayoutItem(kepler.escape_velocity),
        LayoutItem(kepler.hyperbolic_excess_velocity),
        ...
        LayoutItem(kepler.argument_of_latitude),
        LayoutItem(kepler.eccentric_anomaly_wrt_true_anomaly),
        LayoutItem(kepler.true_anomaly_wrt_eccentric_anomaly),
